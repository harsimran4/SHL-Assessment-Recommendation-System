...
def data_extraction(content):
    ...
    assessment_name_pattern = r"Assessment Name:\s*(.*)"
...
if query:
    ...
    for i, doc in enumerate(results, 1):
        ...
        explanation = llm.invoke(f"Explain why the assessment '{extracted_data['Assessment Name']}' is suitable for a '{extracted_data['Job Levels']}' role. and keep it short")
